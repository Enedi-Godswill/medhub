...
export default function Clients(){
    return(
        <div className="flex flex-col sm:flex-row h-[20rem] sm:h-[25rem] justify-center sm:justify-around items-center p-4 gap-3 text-xs sm:text-xl bg-gradient-to-r bg-blue-400 ">
            <div className="w-full sm:w-[25rem] flex flex-col justify-center gap-4 ">
                <h1 className="font-bold uppercase text-xl sm:text-2xl">what our members saying about us</h1>
                <p className="text-xs ">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sapiente, adipisci! Voluptas aliquam dolores unde iste pariatur accusantium facere?</p>
            </div>
            <div className="w-full sm:w-[25rem] flex flex-col justify-center gap-4 p-2 bg-white text-black rounded-md ">
