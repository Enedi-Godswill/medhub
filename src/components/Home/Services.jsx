    ...
    return(
        <div className="p-3">
            ...
            <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 ">
                <li className="flex flex-col justify-center items-center text-center gap-2 text-xl p-2 rounded-md ">
                ...
                <li className="flex flex-col justify-center items-center text-center gap-2 text-xl border-solid rounded-md ">
